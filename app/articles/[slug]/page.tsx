...
function FruitIllustration({ kind }: { kind: string }) {
  const srcMap: Record<string, string> = {
    dust: "/images/evolution-bebe/dust.png",
    poppy: "/images/evolution-bebe/poppy.png",
    sesame: "/images/evolution-bebe/sesame.png",
    lentil: "/images/evolution-bebe/lentil.png",
    pea: "/images/evolution-bebe/pea.png",
    blueberry: "/images/evolution-bebe/blueberry.png",
    raspberry: "/images/evolution-bebe/raspberry.png",
    strawberry: "/images/evolution-bebe/strawberry.png",
    fig: "/images/evolution-bebe/fig.png",
    plum: "/images/evolution-bebe/plum.png",
    lemon: "/images/evolution-bebe/lemon.png",
  };

  const labelMap: Record<string, string> = {
    dust: "Grain de poussière",
    poppy: "Graine de pavot",
    sesame: "Graine de sésame",
    lentil: "Lentille",
    pea: "Petit pois",
    blueberry: "Myrtille",
    raspberry: "Framboise",
  ...
  return (
    <img
      src={srcMap[kind]}
      alt={labelMap[kind] || "Illustration"}
      className="week-fruit-image"
    />
  );
}
